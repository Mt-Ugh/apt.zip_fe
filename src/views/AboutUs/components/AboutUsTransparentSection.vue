<template>
  <section class="aboutus-transparent-section2-centered">
    <div class="aboutus-transparent-img1-centered">
      <img :src="AboutUsImg1" alt="Real estate handshake deal" />
    </div>
    <div class="aboutus-transparent-content1-centered">
      <div class="aboutus-transparent-titlebox1">
        <div class="aboutus-transparent-title1-centered">투명한 거래 정보</div>
      ...
      <div class="aboutus-transparent-desc1-centered">
        ...
        "신뢰"를 최우선으로 합니다.<br />
        투명한 거래 내역과 정확한 실거래가 정보를 신속하게 제공하여, 사용자가 안심하고 믿을 수 있는
        데이터를 전달합니다.
      </div>
    </div>
    <div class="aboutus-transparent-img2-centered">
      <img :src="AboutUsImg2" alt="Urban real estate cityscape" ref="aboutUsImg2" />
    </div>
    <div class="aboutus-transparent-content2-centered">
      <div class="aboutus-transparent-titlebox2">
        <div class="aboutus-transparent-title2-centered">실시간 데이터, 신뢰의 시작</div>
        <div class="aboutus-transparent-subtitle2-centered">최신 부동산 실거래가를 한눈에</div>
      </div>
      <div class="aboutus-transparent-desc2-centered">
        APT.ZIP은 아파트, 오피스텔, 연립주택 등 다양한 부동산의 실거래 정보를 실시간으로
        수집·분석하여 제공합니다.<br />
        <br />
